...
public class HealingFruit extends Item implements IMaryItem {
    public HealingFruit() {
        super(new FabricItemSettings().fireproof().rarity(Rarity.EPIC).maxCount(4).food(new FoodComponent.Builder().snack().alwaysEdible().nutrition(0).saturationModifier(0).build()));
    }
